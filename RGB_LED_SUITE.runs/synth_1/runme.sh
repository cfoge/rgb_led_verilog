...
HD_PWD='C:/Users/robdj/Documents/RMIT_2021/CAP_STONE/RGB_LED_SUITE/RGB_LED_SUITE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led8_to_1mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led8_to_1mux.tcl
